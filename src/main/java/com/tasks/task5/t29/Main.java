...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Площадь сектора=" + circle1.areaS(angleA, angleB));
        System.out.println("Длина дуги=" + circle1.lengthOfArk(angleA, angleB));
        System.out.println("------------------------");
        ...
        System.out.println("Длина дуги=" + circle2.lengthOfArk(angleA, angleB));
        System.out.println("------------------------");
    }
}
